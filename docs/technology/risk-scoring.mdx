...
|-------|---------|--------------|
| **< 40** | APPROVE | The runtime signs, the sponsor EOA relays the SafeTx on-chain immediately. Patterns recorded asynchronously. |
...
Patterns are stored in the database and updated after every confirmed transaction:
